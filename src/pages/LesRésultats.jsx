...
import { getTestRecherche, getTests } from "../services/TestEcritureApi";
import { Cross } from "lucide-react";
import { RxUpdate } from "react-icons/rx";
import { FaFileCircleCheck } from "react-icons/fa6";

const LesRésultats = () => {
  document.title = "Les résultats des tests"
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-2xl font-bold text-gray-800">Les Résultats de test </h2>
        </div>
      ...
      {rech && (
        ...
        <div className="bg-white shadow-md p-6 mt-4 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col gap-1">
              <label className="text-sm font-medium text-gray-700">Statut du Validation</label>
              <select
                className="p-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
          ...
          {isLoading ? (
            ...
            <table className="min-w-full table-auto">
              ...
              <tbody className="divide-y divide-gray-200">
                {isLoading ? (
                  <tr>
                    <td colSpan="100%" className="p-8 text-center text-gray-600">
                    ...
                    <tr key={idx} className="hover:bg-gray-50 transition-colors duration-150">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-600">{row.statutValidation}</td>
                      <td className="px-6 py-4 text-sm text-gray-600">
                        <button
